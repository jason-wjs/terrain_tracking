...
## oracle teacher run_jump_gap_001_dm_dm_aug0_flipped experiment with adaptive sampling mode
...
RUN_NAME="${RUN_NAME:-run_jump_gap_001_dm_dm_aug0_flipped_g1_oracle_teacher_n8192_adaptive}"
