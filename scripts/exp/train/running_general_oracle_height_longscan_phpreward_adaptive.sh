...
## general oracle height long-scan PHP reward over PARC running pairs.
...
RUN_NAME="${RUN_NAME:-running_general_g1_oracle_height_longscan_phpreward_m128_n8192_adaptive}"
