...
## general oracle teacher over all PARC mid_blocks pairs with adaptive sampling.
TASK="${TASK:-TT-Tracking-TerrainOracleTeacherGeneral-Unitree-G1}"
...
RUN_NAME="${RUN_NAME:-mid_blocks_general_g1_oracle_teacher_n16384_adaptive}"
